...
<div class="row">
	<div class="span12">
		...
		<table class="table table-bordered table-striped bump-up-10">
			...
			<tbody cloud-api-url="<?=site_url('cp/api/get?type=bucket&bucket=' . $bucket['BucketsId'] . '&order=' . $prefix . 'Order&sort=DESC&search={{search}}&format=json')?>" cloud-tmpl-cont="data-table-row" cloud-api-search="table-search"></tbody>
		</table>
